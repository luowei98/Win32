...
namespace RobertLw.Win32
{
    ...
    public abstract class WinMM
    {
        ...
        public const int JOY_RETURNALL =
        ...
        public const int MIXERCONTROL_CONTROLTYPE_BOOLEANMETER =
            (MIXERCONTROL_CT_CLASS_METER | MIXERCONTROL_CT_SC_METER_POLLED | MIXERCONTROL_CT_UNITS_BOOLEAN);

        public const int MIXERCONTROL_CONTROLTYPE_BUTTON =
        ...
        public const int MIXERCONTROL_CONTROLTYPE_DECIBELS =
        ...
        public const int MIXERCONTROL_CONTROLTYPE_MICROTIME =
            (MIXERCONTROL_CT_CLASS_TIME | MIXERCONTROL_CT_SC_TIME_MICROSECS | MIXERCONTROL_CT_UNITS_UNSIGNED);

        public const int MIXERCONTROL_CONTROLTYPE_MILLITIME =
        ...
        public const int MIXERCONTROL_CONTROLTYPE_PERCENT =
        ...
        public const int MIXERCONTROL_CONTROLTYPE_SIGNEDMETER =
            (MIXERCONTROL_CT_CLASS_METER | MIXERCONTROL_CT_SC_METER_POLLED | MIXERCONTROL_CT_UNITS_SIGNED);

        public const int MIXERCONTROL_CONTROLTYPE_SINGLESELECT =
        ...
        public const int MIXERCONTROL_CONTROLTYPE_UNSIGNED =
        ...
        [DllImport("winmm")]
        public static extern int mciSendString(string lpstrCommand, StringBuilder lpstrReturnString, int uReturnLength,
                                               IntPtr hwndCallback);
        ...
        [DllImport("winmm")]
        public static extern int midiStreamOpen(int phms, int puDeviceID, int cMidi, int dwCallback, int dwInstance,
                                                int fdwOpen);
        ...
        [DllImport("winmm")]
        public static extern int mmioRename(string szFileName, string SzNewFileName, ref MMIOINFO lpmmioinfo,
                                            int dwRenameFlags);
        ...
        [DllImport("winmm")]
        public static extern int waveOutOpen(int lphWaveOut, int uDeviceID, ref WAVEFORMAT lpFormat, int dwCallback,
                                             int dwInstance, int dwFlags);
